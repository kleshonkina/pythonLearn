...
class PublicTransport:
    def __init__(self, brand: str, engine_power: int, year: int, color: str, max_speed: int):
        """
        Конструктор класса PublicTransport, создает объект PublicTransport с параметрами.
    ...
    def info(self):
        """
        Свойство info выводит на печать информацию о транспорте.
        :return: Строка с информацией о транспорте вида "Марка, Цвет, год выпуска, мощность двигателя"
        """
...
class Bus(PublicTransport):
    def __init__(self,
                 ...
                 fare: int):
        """
        Конструктор класса Bus с параметрами родителя PublicTransport и дополнительными параметрами passenger,
        park и fare.
        :param brand: Марка транспорта
        :param engine_power: Мощность двигателя
        :param year: Год выпуска
    ...
    def park(self):
        """
        Свойство park возвращает свое значение.
        :return: Приписка автобуса.
        """
        return self._park
...
class Tram(PublicTransport):
    def __init__(self,
                 ...
                 fare: int):
        """
        Конструктор класса Tram с параметрами родителя PublicTransport и дополнительными параметрами route, path и fare.
        :param brand: Марка транспорта.
        :param engine_power: Мощность двигателя.
        :param year: Год выпуска.
        :param color: Цвет.
    ...
    def how_long(self):
        """
        Свойство вычисляет время за прохождение маршрута по формуле max_speed/(4*path).
