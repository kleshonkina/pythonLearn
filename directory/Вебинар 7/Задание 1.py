...
class Segment:
    def __init__(self, x1y1: tuple, x2y2: tuple):
        self.x1, self.y1 = x1y1[0], x1y1[1]
        self.x2, self.y2 = x2y2[0], x2y2[1]
    ...
    def x_axis_intersection(self) -> bool:
        """
        Пересекает ли отрезок ось абцисс.
        :return: Пересекает или нет (True or False).
        """
