...
def letter_stat(our_str):
    """
    Метод считает количество вхождений каждой буквы из входящей строки
    и возвращает это в формате словаря, где ключом является буква,
    а значением — количество вхождений.
    :param our_str: Строка текста для подсчета.
    :return: Словарь с ключом-буквой и количеством повторений буквы в качестве значения.
    """
    letters_dict = {}
    for char in our_str:
